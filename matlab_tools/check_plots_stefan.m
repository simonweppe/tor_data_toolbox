...
function check_plots_stefan(matlabfile_processed)

% load('SCT_DATA_FRA56.mat');
load(matlabfile_processed)
addpath('/media/simon/Seagate Backup Plus Drive/theoceanrace/matlab_tools/top_copy/check_plots_stefan');
...
[figDescrip1]= plot_1(matlabfile_processed,1);
disp('Plot_1 done')
[figDescrip2]= plot_2(matlabfile_processed,1,timeframe);
disp('Plot_2 done')
[figDescrip3]= plot_3(matlabfile_processed,1,timeframe);
disp('Plot_3 done')
return

[figDescrip4]= plot_4(matlabfile_processed,1,timeframe);
disp('Plot_4 done')
[figDescrip5]= plot_5(matlabfile_processed,1,timeframe);
disp('Plot_5 done')
[figDescrip6]= plot_6(matlabfile_processed,1,timeframe);
disp('Plot_6 done')
[figDescrip7]= plot_7(matlabfile_processed,1,timeframe);
disp('Plot_7 done')
[figDescrip8]= plot_8(matlabfile_processed,1,timeframe);
disp('Plot_8 done')
[figDescrip9]= plot_9(matlabfile_processed,1,timeframe);
disp('Plot_9 done')
[figDescrip10]= plot_10(matlabfile_processed,1,timeframe,label2, label3);
disp('Plot_10 done')
[figDescrip11]= plot_11(matlabfile_processed,1,timeframe,label2, label3);
disp('Plot_11 done')
[figDescrip12]= plot_12(matlabfile_processed,1,timeframe,label2, label3);
disp('Plot_12 done')
[figDescrip13]= plot_13(matlabfile_processed,1,timeframe,label2, label3);
disp('Plot_13 done')
